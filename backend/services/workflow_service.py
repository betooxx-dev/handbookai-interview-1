...
SYSTEM_PROMPT = """You are a helpful assistant that helps companies design and visualize process workflows. You can communicate in English and Spanish.
...
3. NEVER return empty responses - always provide both explanation and JSON
...
class WorkflowService:
    ...
    def _generate_ai_response(chat_id: int, user_content: str, db: Session) -> Message:
        ...
        system_message = {
            "role": "system",
            "content": SYSTEM_PROMPT + workflow_context,
        }
